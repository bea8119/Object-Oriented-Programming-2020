...
public class MainClass {
    ...
    public static void main(String[] args) throws DeliveryException {
        ...
        int id2 = ds.newCustomer("Il secondo", "1 Castle Black", "+0 610 555 555", "jon@nigh.org");
        int id3 = ds.newCustomer("Al terzo", "1 Castle Black", "+0 610 555 555", "jon.org");
        
        System.out.println(ds.listCustomers());
