...
public class Food {
	...
	private List< Menu> menues= new LinkedList< Menu>();
	...
	public void defineRawMaterial(String name,
									  ...
									  double carbs,
									  double fat){
		 RawMaterial rawmat= new RawMaterial(name,calories, proteins, carbs, fat);		
		 rawMaterials.put(name, rawmat);
	...
	public Recipe createRecipe(String name) {
		Recipe recip= new Recipe(name, this);
		
		recipes.put(name,  recip);
